...
assert.match(bbActionsSlide, /В данных FF за 1 января — 16 июля 2026/);
assert.match(bbActionsSlide, /3-я лига против опена BTN 2 BB при стеке 40–70 BB/);
...
assert.match(css, /\.action-split \{[\s\S]*?grid-template-columns: 13\.6fr 62fr 24\.4fr/);
