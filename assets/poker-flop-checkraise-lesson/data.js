(function () {
  ...
  window.FF_POKER_FIELD_LESSON_DATA = {
    ...
    wisdom: [
      ...
      },
      {
        ...
        visual: {
          ...
          breakeven: 42.97,
          period: "CO/BTN против BB · Q2 2026",
          sizing: {
    ...
    examples: {
      ...
      lead: "Восемь реальных раздач Лиги 1, затем 64 учебные руки по всем типам флопа и пять подробных разборов.",
      note: "BB против CO/BTN: колл префлоп → чек → c-bet.",
      method: "Сначала — восемь реально сыгранных X/R из базы FF. Атлас ниже — учебная стратегия, а не HH поля; отдельная раздача не задаёт частоту или рекомендацию.",
      observedLeague1: {
      ...
      boardAtlas: {
        ...
        note: "Это учебная стратегия, а не HH поля. Пограничные руки могут смешивать действия против другого сайза, стека или диапазона.",
        structures: [
          atlasStructure("a_high_dry", "A-high · сухая", ["Ac", "7d", "2s"], "Сеты добирают, сильные пары ловят блефы, лучшие колёсные дро дают полублеф.", [
            atlasGroup("value", "Вэлью X/R", "Чек-рейз", [
          ...
          atlasStructure("k_high_dry", "K-high · сухая", ["Kc", "8h", "2s"], "Сильное вэлью и лучшие бэкдоры рейзят; обычные Kx и вторые пары защищают колл.", [
            atlasGroup("value", "Вэлью X/R", "Чек-рейз", [
          ...
          atlasStructure("paired", "Спаренная / trips", ["9c", "9d", "2s"], "Натсовое вэлью рейзит, средние пары часто ловят блефы, воздух выбирается очень строго.", [
            atlasGroup("value", "Вэлью X/R", "Чек-рейз", [
          ...
          atlasStructure("monotone", "Монотонная", ["As", "8s", "3s"], "Готовые флеши рейзят выборочно; пары без пики и слабый воздух чаще контролируют или сдаются.", [
            atlasGroup("value", "Вэлью X/R", "Чек-рейз · микс", [
            ...
            atlasGroup("semi_bluff", "Полублеф / дро", "Чек-рейз · редко", [
              atlasHand("KQo", ["Ks", "Qh"], "K-high флеш-дро", "Пика закрывает сильный флеш, а король или дама иногда дают дополнительное шоудаун-вэлью.", "Продолжай на пиках и аккуратно выбирай баррели на K/Q."),
