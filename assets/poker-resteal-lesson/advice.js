(function (root, factory) {
  ...
  const TIPS = [
...

    {
      ...
      copy: "Соперник заколлировал, и эта раздача проиграна. Оценивай не последнюю карту, а все ветки решения: пас соперника, победу при колле и поражение при колле.",
    ...
    },
    {
      ...
      family: "green-caller",
      priority: 111,
      title: "Любитель защищает опен шире обычного",
    ...
    },
    {
      ...
      family: "green-caller",
      priority: 114,
      title: "Иногда даже зелёный покажет очень сильную руку",
...

    {
      ...
      copy: "Это повторная встреча с сильным соперником. Он может открываться аккуратнее и коллировать шире, если заметил твою частоту — теперь выбор рук важнее.",
    ...
    },
    {
      ...
      family: "future-game",
      priority: 82,
      title: "Не бойся заметки после одного широкого пуша",
